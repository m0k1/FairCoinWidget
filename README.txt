...
That is a fork from Coinwidget, created by http://scotty.cc/
...
A. Grab the latest version from GitHub: 
	https://github.com/yyuri/FairCoinWidget
...
You can also use the wizard on https://getfaircoin.net/widget/ to generate linking codes, just be sure to change: 
<script src="https://getfaircoin.net/widget/widget/coin.js"></script> to use your own hosted copy of coin.js.
